...
const ActivityTimelineCard = () => {
  const activities = [
    ...
    },
    {
      ...
      type: "project",
      teamMembers: [
        { name: "Howard Lloyd", avatarSrc: "/images/avatars/avatar-5.png" },
        { name: "Katie Lane", avatarSrc: "/images/avatars/avatar-12.png" },
        { name: "George Allen", avatarSrc: "/images/avatars/avatar-9.png" },
        { name: "Alice Cobb", avatarSrc: "/images/avatars/avatar-6.png" },
        { name: "Jeffery Warner", avatarSrc: "/images/avatars/avatar-14.png" },
      ],
      dotColor: "info",
    },
  ];
