...
const TotalRevenueChart = () => {
  ...
  useEffect(() => {
    const data2022 = allData.find(
      (item) => item.id === "totalRevenue2022"
    );

    const data2023 = allData.find(
      (item) => item.id === "totalRevenue2023"
    );
    const spacer = allData.find(
      (item) => item.id === "totalRevenueSpacer"
    );
  ...
  //       const data2022 = fetchedData.find(
  //         (item) => item.id === "totalRevenue2022"
  //       );
  //       const data2023 = fetchedData.find(
  //         (item) => item.id === "totalRevenue2023"
  //       );
  //       const spacer = fetchedData.find(
  //         (item) => item.id === "totalRevenueSpacer"
  //       );
      ...
      <Grid item xs={12} sm={5} xl={4}>
        ...
        >
          <CardContent>
            ...
            <Typography
              variant="body1"
              style={{ marginTop: "2px", marginLeft: "40px" }}
            >
              62% Company Growth
            </Typography>
