    ...
    useEffect(() => {
      async function getData() {
        try {
          ...
          const Performance1 = fetchedData.find(item => item.id === 'Performance1');
            const Performance2 = fetchedData.find(item => item.id === 'Performance2');
  ...
  return (
    <Grid>
      <Card>
        ...
        <CardContent>
          <Box display="flex">
            <Typography variant="body2" component="p" color={'rgba(50, 71, 92, 0.6)'}>
              <strong>Earning:</strong> $846.17
            </Typography>
            <Typography variant="body2" component="p" sx={{marginLeft:'3rem', color:'rgba(50, 71, 92, 0.6)'}}>
