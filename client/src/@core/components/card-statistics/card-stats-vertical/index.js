    ...
    <Card>
      <CardContent>
        <Box sx={{ display: 'flex', marginBottom: 5.5, alignItems: 'flex-start', justifyContent: 'space-between' }}>
          <Box sx={{marginRight: 4, color: 'common.white', backgroundColor: 'transparent', borderRadius: 5}}>
            {icon}
          </Box>
        ...
        <Typography sx={{ fontWeight: 600, color: 'rgba(50, 71, 92, 0.6)', fontSize: '1rem', mt:-2}}>{title}</Typography>
        ...
        <Typography variant='caption' sx={{color: '#71dd37'}}>{subtitle}</Typography>
      </CardContent>
    </Card>
  )
}
