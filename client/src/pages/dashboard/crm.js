...
import { sendDataToBackend } from "src/@core/services/crmDataService";
    ...
    <ApexChartWrapper>
      <Grid container spacing={6}>
        ...
        <Grid item xs={12} md={6} lg={4}>
          <Grid container spacing={6}>
            <Grid item xs={6}>
              <Sessions title="Sessions" stats="2845" />
            </Grid>
            <Grid item xs={6}>
              <CardStatisticsVerticalComponent
                ...
                icon={
                  <img
                    src="http://127.0.0.1:8000/cards/stats-vertical-cube.png"
                    alt="Sales"
        ...
        <Grid item xs={12} md={6} lg={4}>
          <TopProductsCard title="Sales" datas={ProductsSales} />
        </Grid>
        <Divider sx={{ ml: -5.7 }} />
        <Grid item xs={12} md={6} lg={4}>
          <TopProductsCard title="Volume" datas={ProductsVolume} />
        </Grid>
        <Grid item xs={12} md={6} lg={4}>
          <EarningReportCard />
        </Grid>
        ...
        <Grid item xs={12} md={6} lg={4}>
          <SalesCountries datas={Countries} />
        </Grid>
        <Grid item xs={12} md={6} lg={4}>
          <SalesStats />
        </Grid>
