...
const Company = ({
  ...
  // const companyEmails = useSelector((state) =>
  //   state.emailData.allData.filter(
  //     (email) => email.labels.includes("company") && !email.status.includes("trash") &&
  ...
  const handleSpam = (event, emailId) => {
    event.stopPropagation();
                      ...
                      {hoveredEmailId === email.id ? (
                        <Box>
                          ...
                          <IconButton
                            ...
                            onClick={(event) => handleSpam(event, email.id)}
                          >
                            <ReportIcon />
                          </IconButton>
                        </Box>
