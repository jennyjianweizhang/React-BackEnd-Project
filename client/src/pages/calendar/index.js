...
const AppCalendar = () => {
  ...
  const handleAddEventClick = () => {
    ...
    const handleCheckboxChange = (event) => {
        ...
        if (name === "viewAll") {
            // Set all categories to the same state if 'View All' is toggled
            setFilters({
                viewAll: checked,
                personal: checked,
                business: checked,
            ...
            // Check if all other categories are true, and update 'viewAll' accordingly
            const allChecked = Object.entries(updatedFilters)
                .filter(([key]) => key !== "viewAll")
                .every(([, value]) => value);  // Check if every filter is true
