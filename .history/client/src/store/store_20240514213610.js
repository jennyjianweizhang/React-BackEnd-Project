...
import eventDataReducer from "./eventsData";
import invoiceDataReducer from "./invoiceData";
...
const reducer = combineReducers({
  ...
  eventsData: eventDataReducer,
  invoicesData: invoiceDataReducer
});

const persistConfig = {
  key: "root",
  storage,
  whitelist: ["user", "ecommerceData", "crmData", "analyticsData", "emailData", "chatData", "eventsData", "invoiceData"],
};
