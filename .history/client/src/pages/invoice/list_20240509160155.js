...
const List = () => {
    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <Tooltip title="Preview">
          <IconButton aria-label="Preview" size="small" component="a" href="/apps/invoice/preview/">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
        ...
        <Tooltip title="More Options">
          <IconButton aria-label="More Options" size="small" onClick={handleClick}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
        ...
        <Menu
                ...
                onClose={handleClose}
              >
                <MenuItem onClick={handleClose}>Dow</MenuItem>
  ...
  const columns = [
    ...
    {field: "status", headerName: <StatusIcon />, width: 120, renderCell: (params) => (<div style={{marginTop:'0.5rem'}}>{params.value}</div>) },
    ...
    { field: "actions", headerName: "ACTIONS", width: 180, renderCell: ActionsCell},
  ];
  ...
  const statusIcons = {
    ...
    Downloaded: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35 35" fill="blue" width="35px" height="35px" style={{borderRadius:'50%'}}>
        <rect width="100%" height="100%" fill="rgba(3, 195, 236, 0.16)"/> 
        <path fill="rgb(3, 195, 236)" transform="translate(5.5, 5.5)" d="M12 1.993C6.486 1.994 2 6.48 2 11.994c0 5.513 4.486 9.999 10 10c5.514 0 10-4.486 10-10s-4.485-10-10-10.001zm0 18.001c-4.411-.001-8-3.59-8-8c0-4.411 3.589-8 8-8.001c4.411.001 8 3.59 8 8.001s-3.589 8-8 8z"></path>
        <path fill="rgb(3, 195, 236)"transform="translate(5.5, 5.5)" d="M13 8h-2v4H7.991l4.005 4.005L16 12h-3z"></path>
      </svg>
    ),
    Sent: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35 35" fill="orange" width="35px" height="35px" style={{borderRadius:'50%'}}>
        <rect width="100%" height="100%" fill="rgba(133, 146, 163, 0.16)"/> 
        <path fill="rgb(133, 146, 163)" transform="translate(5.5, 5.5)" d="M20.56 3.34a1 1 0 0 0-1-.08l-17 8a1 1 0 0 0-.57.92a1 1 0 0 0 .6.9L8 15.45v6.72L13.84 18l4.76 2.08a.93.93 0 0 0 .4.09a1 1 0 0 0 .52-.15a1 1 0 0 0 .48-.79l1-15a1 1 0 0 0-.44-.89ZM18.1 17.68l-5.27-2.31L16 9.17l-7.65 4.25l-2.93-1.29l13.47-6.34Z"></path>
      </svg>
    ),
    Draft: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35 35" fill="gray" width="35px" height="35px" style={{borderRadius:'50%'}}>
        <rect width="100%" height="100%" fill="rgba(105, 108, 255, 0.16)"/> 
        <path fill="rgb(105, 108, 255)" transform="translate(5.5, 5.5)" d="M5 21h14a2 2 0 0 0 2-2V8l-5-5H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2zM7 5h4v2h2V5h2v4H7V5zm0 8h10v6H7v-6z"></path>
      </svg>
    ),
    "Partial Payment": (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35 35" fill="purple" width="35px" height="35px" style={{borderRadius:'50%'}}>
         <rect width="100%" height="100%" fill="rgba(255, 171, 0, 0.16)"/> 
        <path fill="rgb(255, 171, 0)" transform="translate(5.5, 5.5)" d="M12 22c5.514 0 10-4.486 10-10S17.514 2 12 2S2 6.486 2 12s4.486 10 10 10zm0-18c4.411 0 8 3.589 8 8s-3.589 8-8 8s-8-3.589-8-8s3.589-8 8-8z"></path>
        <path fill="rgb(255, 171, 0)" transform="translate(5.5, 5.5)" d="M19 12a7 7 0 0 0-7-7v14a7 7 0 0 0 7-7z"></path>
      </svg>
    )
  };
            ...
            <Grid container spacing={2}>
              <Grid item xs={12}>
                ...
                <DataGrid
                  ...
                  checkboxSelection
                  sx={{height: "100vh", '& .MuiDataGrid-cell:focus, & .MuiDataGrid-cell:focus-within': {
                    outline: 'none',
                  }}}
                />
              </Grid>
