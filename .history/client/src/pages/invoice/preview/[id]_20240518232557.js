  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12} md={8} xl={9}>
        <Card elevation={6}>
          <CardContent sx={{ height: "170vh", mt: 5 }}>
                ...
                <Box sx={{ padding: 2, mt: 5 }}>
                  <Grid container spacing={2}>
                    <Grid item xs={6} sx={{ ml: 10 }}>
                      <Typography variant="h6" sx={{ ml: -10, mt: -5 }}>
                        Invoice #{id}
                      </Typography>
                      <Typography
                        variant="body1"
                      ...
                      >
                        Date Issued:{issueDate.toLocaleDateString()}
                      </Typography>
                      <Typography
                        variant="body1"
                        sx={{
                      ...
                      >
                        Date Due: {dueDate.toLocaleDateString()}
                      </Typography>
                    </Grid>
                    <Grid item xs={6}>
                      <Divider
                        sx={{ mt: 15, mb: 2, ml: -120, width: "43rem" }}
                      />
                    </Grid>
                    {/* <Grid container spacing={2} sx={{ml:-140, mt:25}}>
              ...
              <Box>
                <Box sx={{ padding: 2, mt: 5 }}>
                  <Grid container spacing={2}>
                    ...
                    <Divider sx={{ mt: 8, mb: 8, width: "43rem" }} />
                    <Grid>
                    <CardTableContainer component={Paper}&gt;
      <CardTable aria-label="customized table"&gt;
        <CardTableHead&gt;
          <CardTableRow&gt;
            <CardTableCell&gt;Item<Card/TableCell&gt;
            <CardTableCell&gt;Description<Card/TableCell&gt;
            <CardTableCell align="right"&gt;Hours<Card/TableCell&gt;
            <CardTableCell align="right"&gt;Qty<Card/TableCell&gt;
            <CardTableCell align="right"&gt;Total<Card/TableCell&gt;
          <Card/TableRow&gt;
        <Card/TableHead&gt;
        <CardTableBody&gt;
          <CardTableRow&gt;
            <CardTableCell&gt;Premium Branding Package<Card/TableCell&gt;
            <CardTableCell&gt;Branding &amp; Promotion<Card/TableCell&gt;
            <CardTableCell align="right"&gt;48<Card/TableCell&gt;
            <CardTableCell align="right"&gt;1<Card/TableCell&gt;
            <CardTableCell align="right"&gt;$32<Card/TableCell&gt;
          <Card/TableRow&gt;
          <CardTableRow&gt;
            <CardTableCell&gt;Social Media<Card/TableCell&gt;
            <CardTableCell&gt;Social media templates<Card/TableCell&gt;
            <CardTableCell align="right"&gt;42<Card/TableCell&gt;
            <CardTableCell align="right"&gt;1<Card/TableCell&gt;
            <CardTableCell align="right"&gt;$28<Card/TableCell&gt;
          <Card/TableRow&gt;
          <CardTableRow&gt;
            <CardTableCell&gt;Web Design<Card/TableCell&gt;
            <CardTableCell&gt;Web designing package<Card/TableCell&gt;
            <CardTableCell align="right"&gt;46<Card/TableCell&gt;
            <CardTableCell align="right"&gt;1<Card/TableCell&gt;
            <CardTableCell align="right"&gt;$24<Card/TableCell&gt;
          <Card/TableRow&gt;
          <CardTableRow&gt;
            <CardTableCell&gt;SEO<Card/TableCell&gt;
            <CardTableCell&gt;Search engine optimization<Card/TableCell&gt;
            <CardTableCell align="right"&gt;40<Card/TableCell&gt;
            <CardTableCell align="right"&gt;1<Card/TableCell&gt;
            <CardTableCell align="right"&gt;$22<Card/TableCell&gt;
          <Card/TableRow&gt;
        <Card/TableBody&gt;
      <Card/Table&gt;
    <Card/TableContainer&gt;
            ...
            >
              ...
              <form>
                ...
                <Button
                  ...
                  variant="contained"
                  sx={{ mr: 1, mt: 2 }}
                  onClick={togglePaymentDrawer(false)}
                >
                  Send
                </Button>
                <Button
