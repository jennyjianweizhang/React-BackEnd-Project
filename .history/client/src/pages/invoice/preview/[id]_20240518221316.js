          ...
          <CardContent sx={{ height: "170vh" }}>
            <Grid container sx={{display:'flex'}}>
              <Grid item xs={12} xl={6}>
                <div style={{ display: "flex", padding: 2, marginLeft: 10, width:'20rem' }}>
                  <svg
                    width="22"
                    height="32"
                    viewBox="0 0 55 81"
                ...
                <div style={{ marginTop: 20, padding: 2, marginLeft: 10, width:'20rem'  }}>
              ...
              <Grid item xs={12} xl={6} sx={{width:'20rem'}}>
