  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12} md={8} xl={9}>
        <Card elevation={6}>
          <CardContent sx={{ minHeight: "100vh", mt: 5 }}>
              ...
              <Box sx={{ width: "10rem" }}>
                <Box sx={{ padding: 2, mt: 5 }}>
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={6}>
                      <Divider
                        sx={{ mt: 15, mb: 2, ml: -120, width: { xs: '100%', md: '43rem' }}}
                      />
                    </Grid>
              ...
              <Box>
                <Box sx={{ padding: 2, mt: 5 }}>
                  <Grid container spacing={2}>
                    <Grid container spacing={2}>
                      <Grid item xs={12} sm={6}>
                        ...
                        <Grid container spacing={2} sx={{ mt: 2, ml: 3 }}>
                          <Grid item xs={12}>
                            <Typography variant="body1">{invoiceTo}</Typography>
                            <Typography variant="body1">
                              {customer.companyName}
                            </Typography>
                            <Typography variant="body1">
                    ...
                    <Divider sx={{ mt: 8, mb: 8, width: { xs: '100%', md: '43rem' }}} />
                    <Grid container spacing={2}>
                      <Grid item xs={12}>
                    ...
                    <Grid container spacing={2}>
                      <Grid item xs={12} sm={6} sx={{mt:10}}>
                        <Typography sx={{color:'rgba(50, 71, 92, 0.6)'}}>Salesperson: Tommy Shelby </Typography>
                        <Typography sx={{color:'rgba(50, 71, 92, 0.6)'}}>Thanks for your business </Typography>
                      </Grid>
                      <Grid item xs={12} sm={6} sx={{mt:10}}>
                        <Box sx={{ padding: 2 }}>
                          <Box
                          ...
                          >
                            <Typography variant="body1" sx={{color:'rgba(50, 71, 92, 0.6)'}}>Subtotal:</Typography>
                            <Typography variant="body1" sx={{color:'rgba(50, 71, 92, 0.6)'}}>
                              $154.25
                            </Typography>
                          </Box>
                          <Box
                          ...
                          >
                            <Typography variant="body1" sx={{color:'rgba(50, 71, 92, 0.6)'}}>Discount:</Typography>
                            <Typography variant="body1" sx={{color:'rgba(50, 71, 92, 0.6)'}}>
                              $00.00
                            </Typography>
                          </Box>
                          ...
                          >
                            <Typography variant="body1" sx={{color:'rgba(50, 71, 92, 0.6)'}}>Tax:</Typography>
                            <Typography variant="body1" sx={{color:'rgba(50, 71, 92, 0.6)'}}>
                              $50.00
                            </Typography>
                          </Box>
                          ...
                          >
                            <Typography variant="body1" sx={{color:'rgba(50, 71, 92, 0.6)'}}>Total:</Typography>
                            <Typography variant="body1" sx={{color:'rgba(50, 71, 92, 0.6)'}}>
                              $204.25
                            </Typography>
                          </Box>
                    ...
                    <Divider sx={{ mt: 8, mb: 8, width: { xs: '100%', md: '40rem' }}} />
                    <Grid container spacing={2}>
                      <Grid item xs={12}>
                        
                        <Typography sx={{color:'rgba(50, 71, 92, 0.6)'}}>Note: It was a pleasure working with you and your team. We hope you will keep us in mind for future freelance projects. Thank You! </Typography>
                      </Grid>
      ...
      <Grid item xs={12} md={4} xl={3}>
        <Card elevation={6}>
          <CardContent>
          <InvoiceDrawer customer={customer}/>
