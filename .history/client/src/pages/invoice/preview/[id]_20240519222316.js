        ...
        <Card elevation={6}>
          <CardContent sx={{ height: "170vh", mt: 5 }}>
            ...
            <Box>
              ...
              <Typography variant="body1">Tommy Shelby</Typography>
            </Box>
            <Typography variant="body1">Thanks for your business</Typography>
          </Grid>
          <Grid item xs={12} sm={5} lg={3}>
            <Box>
              <Typography variant="body1">Subtotal:</Typography>
              <Typography variant="body1">$154.25</Typography>
            </Box>
            <Box>
            ...
            <Box>
              ...
              <Typography variant="body1">$204.25</Typography>
            </Box>
          </Grid>
                    </Grid>
                  </Grid>
