...
const List = () => {
  ...
  const handleSelectionChange = (event) => {
    console.log("Event:", event); // Log the entire event to see the structure
    setSelectedRowIds(event.selectionModel || []); // Adjust depending on the actual structure
  };
  

  console.log("Rendering DataGrid with rows:", rows.length);
