        ...
        <Box>
          ...
          <Box>
            <TextField
              ...
              fullWidth
            />
            <Button variant="contained" color="primary" href="/apps/invoice/add/">
              Create Invoice
            </Button>
          </Box>
        </Box>
        <DataGrid autoHeight withBorderColor density="standard">
          {/* Column and row definitions similar to the HTML structure */}
        </DataGrid>
      </Paper>
    </Grid>
    </Grid>
