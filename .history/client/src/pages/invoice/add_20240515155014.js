                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={6}>
                      ...
                      <DatePicker
                        ...
                        dateFormat="MM/dd/yyyy"
                        customInput={
                          <TextField sx={{ mt: 13, ml: -48, width: "12rem" }} />
                        }
                      />
                      ...
                      {items.map((item, index) => (
                        ...
                        >
                          <Box sx={{ display: "flex" }}>
                            ...
                            <Typography sx={{ marginBottom: 2, ml: 16 }}>
                              Price
                            </Typography>
                          </Box>
                          <Grid container spacing={2}>
                            ...
                            <Grid
                              ...
                              sx={{
                                ...
                                pl: -4, // padding-left inside the Grid item, to space content away from the border
                                display: "flex",
                                alignItems: "center", // Vertically center the icon button within the grid
                                justifyContent: "center", // Horizontally center the icon button
                              }}
                            >
                              <IconButton
