  ...
  const statusIcons = {
    ...
    "Partial Payment": (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35 35" fill="purple" width="24px" height="24px" style={{borderRadius:'50%'}}>
        ...
        <path fill="rgb(255, 171, 0)" d="M12 22c5.514 0 10-4.486 10-10S17.514 2 12 2S2 6.486 2 12s4.486 10 10 10zm0-18c4.411 0 8 3.589 8 8s-3.589 8-8 8s-8-3.589-8-8s3.589-8 8-8z"></path>
      </svg>
    )
  };
