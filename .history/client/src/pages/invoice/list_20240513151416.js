...
import {setSearchTerm } from "src/store/invoiceData"
...
const List = () => {
  ...
  const invoice = useSelector((state) => state.invoiceData?.invoice || []);
  console.log(invoice);

  const selectSearchTerm = (state) => state.invoiceData.searchTerm;
              ...
              <Grid item xs={12}>
                ...
                <DataGrid
                  ...
                  columns={[
                    ...
                    { field: "total", headerName: "TOTAL", width: 110, renderCell: (params) => (
                      <div style={{textAlign: "center" }}>
                        {params.value}
                      </div>
                    ), },
                    ...
                    { field: "balance", headerName: "BALANCE", width: 130, renderCell: (params) => (
                      <div style={{textAlign: "center" }}>
                        {params.value}
                      </div>
                    ), },
