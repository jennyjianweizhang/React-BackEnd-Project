...
const List = () => {
  ...
  const handleSelectionChange = (event) => {
    ...
    setSelectedRowIds(event.selectionModel || []); 
  };
          ...
          <CardContent>
            <Grid container spacing={2}>
              <Grid item xs={12}>
                ...
                /> */}
                <DataGrid
  rows={[{ id: 1, name: 'Test User' }, { id: 2, name: 'Another User' }]}
  columns={[{ field: 'id', headerName: 'ID', width: 90 }, { field: 'name', headerName: 'Name', width: 110 }]}
  checkboxSelection
