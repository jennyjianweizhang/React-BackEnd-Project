            ...
            <Grid container>
              <Grid item xs={12} xl={6}>
                <div style={{display:'flex'}}>
                  ...
                  <Typography variant="h5" sx={{ml:3, fontWeight:700, color:'rgba(50, 71, 92, 0.87)'}}>Sneat</Typography>
                </div>
                <div style={{marginTop:20}}><Typography style={{color:'rgba(50, 71, 92, 0.6'}}>Office 149, 450 South Brand Brooklyn</Typography>
                <Typography style={{color:'rgba(50, 71, 92, 0.6'}}>San Diego County, CA 91905, USA</Typography>
                <Typography style={{color:'rgba(50, 71, 92, 0.6'}}>+1 (123) 456 7891, +44 (876) 543 2198</Typography></div>
                <Box sx={{ padding: 2 }}>
        <Typography variant="h5" sx={{ marginBottom: 2 }}>Invoice</Typography>
        <TextField
          id="invoice-number"
          label="Invoice #"
          variant="outlined"
