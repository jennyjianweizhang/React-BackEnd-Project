              ...
              <Grid item xs={12} xl={6}>
                ...
                <Box sx={{ padding: 2, mt: 5 }}>
                  <Grid container spacing={2}>
                    ...
                    <Divider sx={{ mt: 4, mb: 8, width: "40rem" }} />
                    <Box sx={{ width: "40rem" }}>
                      <TextField
                        fullWidth
                        label="Note"
            ...
            <FormGroup>
              ...
              <FormControlLabel
                control={
                  <Switch
                    checked={clientNotes}
                    onChange={(e) => setClientNotes(e.target.checked)}
                  />
                }
                label="Client Notes"
              />
              <FormControlLabel
                control={
                  <Switch
                    checked={paymentStub}
                    onChange={(e) => setPaymentStub(e.target.checked)}
                  />
                }
                label="Payment Stub"
              />
