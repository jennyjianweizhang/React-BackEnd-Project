...
const List = () => {
  ...
  const statusIcons = {
    Paid: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="green" width="30px" height="30px" style={{borderRadius:'50%'}}>
        <rect width="200%" height="200%" fill="rgba(113, 221, 55, 0.16)"/> 
