  ...
  return (
    <Grid container spacing={6}>
                ...
                <Box sx={{ padding: 2, mt: 5}}>
                  <Grid container spacing={2}>
                    <Grid item xs={6}>
                      ...
                      <Typography variant="body1" sx={{ mt:8, mb: 2, color:'rgba(50, 71, 92, 0.6)' }}>
                        Date Issued:
                      </Typography>
                      <Typography variant="body1" sx={{mt:10, color:'rgba(50, 71, 92, 0.6)'}}>Date Due:</Typography>
                    </Grid>
                    <Grid item xs={6}>
                      <TextField
                        id="invoice-number"
                      ...
                      customInput={<TextField sx={{ marginBottom: 2, ml: -50, width: '12rem', display:'block' }}/>}
                    ...
                    />
                      ...
                      dateFormat="MM/dd/yyyy"
                      customInput={<TextField sx={{mt:13, ml:-50, width: '12rem'}}/>}
                    />
      ...
      <Grid item xs={12} sm={6}>
                <Typography variant="body1" gutterBottom>Invoice To:</Typography>
                <TextField
                  fullWidth
                  variant="outlined"
                  disabled
                  value="Invoice recipient's name"
                />
                <Table size="small">
                  <TableBody>
                    <TableRow>
              ...
              <Grid item xs={12} sm={6}>
                <Typography variant="body1" gutterBottom>Bill To:</Typography>
                <TextField
                  fullWidth
                  variant="outlined"
                  disabled
                  value="Bill recipient's name"
                />
