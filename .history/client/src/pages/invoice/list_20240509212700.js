...
const List = () => {
  ...
  const generateFilteredRows = () => {
    const allRows = generateRows(); // This should be your function that initially generates all rows
    return selectedStatus ? allRows.filter(row => row.status === selectedStatus) : allRows;
  };
