...
const edit = () => {
  ...
  const [invoiceSentFrom, setInvoiceSentFrom] = useState(customer.email);
  const [invoiceSentTo, setInvoiceSentTo] = useState("qConsolidated@email.com");
  const [invoiceSubject, setInvoiceSubject] = useState("Invoice of purchased Admin Templates");
