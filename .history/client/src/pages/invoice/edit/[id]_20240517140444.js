...
<Grid item xs={12}>
  ...
  <Typography variant="body1"><strong>Compa</strong> {companyName}</Typography>
  <Typography variant="body1"><strong>Addre</strong> {address}</Typography>
  <Typography variant="body1"><strong>Pho</strong> {phoneNumber}</Typography>
  <Typography variant="body1"><strong>Ema</strong> {email}</Typography>
</Grid></Grid>
                        <Drawer
                          anchor="right"
                          open={isDrawerOpen}
