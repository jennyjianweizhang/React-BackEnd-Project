...
const edit = () => {
  ...
  const closeInvoiceDrawer = () => setPaymentDrawerOpen(false);
              ...
              <form>
               ...
               <TextField
                ...
                <TextField
                    ...
                    variant="outlined"
                  />
                <Button type="submit" variant="contained" sx={{ mr: 1, mt:2 }} onClick={closeInvoiceDrawer}>
                  Send
                </Button>
                <Button variant="outlined" onClick={closeInvoiceDrawer} sx={{mt:2}}>
                  Cancel
                </Button>
              </form>
            </Drawer>
              ...
              <form>
               ...
               <TextField
                ...
                <TextField
                    ...
                    variant="outlined"
                  />
                <Button type="submit" variant="contained" sx={{ mr: 1, mt:2 }} onClick={closePaymentDrawer}>
                  Send
                </Button>
                <Button variant="outlined" onClick={(e)=>{e.stopPropagation();setPaymentDrawerOpen(false)}closePaymentDrawer} sx={{mt:2}}>
                  Cancel
                </Button>
              </form>
            </Drawer>
