...
const edit = () => {
  ...
  useEffect(() => {
    if (invoice) {
      ...
      const customerDetails = allCustomers.find(cust => cust.client === invoice.client);
      if (customerDetails) {
        setCustomer({
      ...
      <Grid item xs={12} md={4} xl={3}>
        <Card elevation={6}>
          <CardContent>
            ...
            <Button variant="outlined" sx={{bgcolor:'rgb(113, 221, 55)', mt:2, color: 'white', borderColor:'rgb(113, 221, 55)'}} fullWidth>
              $ Add Payment 
            </Button>
            <Drawer
                          anchor="right"
