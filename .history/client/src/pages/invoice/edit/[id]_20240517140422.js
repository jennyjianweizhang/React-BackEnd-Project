...
<Grid item xs={12}>
  <Typography variant="h6">Customer Detai</Typography>
  <Typography variant="body1"><strong>Compa</strong> {customer.companyName}</Typography>
  <Typography variant="body1"><strong>Addre</strong> {customer.address}</Typography>
  <Typography variant="body1"><strong>Pho</strong> {customer.phoneNumber</Typography>
  <Typography variant="body1"><strong>Ema</strong> {customer.email</Typography>
</Grid></Grid>
                        <Drawer
                          anchor="right"
                          open={isDrawerOpen}
