...
const edit = () => {
  ...
  useEffect(() => {
    if (paymentDrawerOpen && invoice) {
      // Assuming invoice is your selected invoice and has the balance
              ...
              <form>
               ...
               <TextField
                ...
                <TextField
                    ...
                    variant="outlined"
                  />
                <Button type="submit" variant="contained" sx={{ mr: 1 }} onClick={togglePaymentDrawer(false)}>
                  Send
                </Button>
                <Button variant="outlined" onClick={togglePaymentDrawer(false)}>
                  Cancel
                </Button>
              </form>
            </Drawer>
