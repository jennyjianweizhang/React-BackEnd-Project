  ...
  const handleSelectCustomer = (event) => {
    ...
    if (selectedCustomer) {
      ...
      setCustomer({
        ...
        country: selectedCustomer.country || 'USA', // default to 'USA' if no country is set
                        ...
                        <Grid container spacing={2} sx={{ mt: 2 }}>
                          <Grid item xs={12}>
                            <Typography variant="body1">
                              <strong>Compa</strong>{selectedCustomer.companyName}
                            </Typography>
                            <Typography variant="body1">
                              <strong>Addre</strong> {customer.address}
                            </Typography>
                            <Typography variant="body1">
                              <strong>Pho</strong> {customer.phoneNumber}
                            </Typography>
                            <Typography variant="body1">
                              <strong>Ema</strong> {customer.email}
                            </Typography>
                          </Grid>
                        </Grid>
                        <Drawer
