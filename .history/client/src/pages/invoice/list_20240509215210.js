...
const List = () => {
  ...
  const initialRows = [
    ...
    { id: 11, status: 'Paid', client: 'Valerie Perez', total: '$3357', issuedDate: '2024-05-17', balance: '$400' },
    { id: 12, status: 'Sent', client: 'Susan Dickerson', total: '$4578', issuedDate: '2024-05-17', balance: '$400' },
  ];
