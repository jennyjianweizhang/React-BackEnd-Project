...
const List = () => {
  ...
  const initialRows = [
    ...
    { id: 7, status: 'Downloaded', client: 'Amanda Phillips', total: '$3710', issuedDate: '2024-05-17', balance: '815' },
    { id: 8, status: 'Past Due', client: 'Christina Collier', total: '$2720', issuedDate: '2024-05-17', balance: '-$200' },
