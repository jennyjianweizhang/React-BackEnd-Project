...
const List = () => {
  ...
  const handleClickOutside = (event) => {
    ...
    // .contains(event.target) is a standard DOM method that returns true if the node (event.target) is a descendant of the node (wrapperRef.current), meaning the click was inside the div.
