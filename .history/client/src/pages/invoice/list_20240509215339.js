...
const List = () => {
  ...
  const initialRows = [
    ...
    { id: 2, status: 'Draft', client: 'Stephanie Burns', email:'don85@johnson.com', total: '$1200', issuedDate: '2024-05-14', balance: '$600' },
    { id: 3, status: 'Sent', client: 'Alice Johnson', email:'don85@johnson.com', total: '$1500', issuedDate: '2024-05-15', balance: '$1500' },
    { id: 4, status: 'Downloaded', client: 'Bob Brown', email:'don85@johnson.com', total: '$700', issuedDate: '2024-05-16', balance: 'Paid' },
    { id: 5, status: 'Partial Payment', client: 'Tony Herrera', email:'don85@johnson.com', total: '$3428', issuedDate: '2024-05-17', balance: '$400' },
    { id: 6, status: 'Partial Payment', client: 'Kevin Patton', email:'don85@johnson.com', total: '$5200', issuedDate: '2024-05-17', balance: 'Paid' },
    { id: 7, status: 'Downloaded', client: 'Amanda Phillips', email:'don85@johnson.com', total: '$3710', issuedDate: '2024-05-17', balance: '815' },
    { id: 8, status: 'Past Due', client: 'Christina Collier', email:'don85@johnson.com', total: '$2720', issuedDate: '2024-05-17', balance: '-$200' },
    { id: 9, status: 'Sent', client: 'Carol White', email:'don85@johnson.com', total: '$2770', issuedDate: '2024-05-17', balance: '$400' },
    { id: 10, status: 'Past Due', client: 'David Flores', email:'don85@johnson.com', total: '$4360', issuedDate: '2024-05-17', balance: 'Paid' },
    { id: 11, status: 'Paid', client: 'Valerie Perez', email:'don85@johnson.com', total: '$3357', issuedDate: '2024-05-17', balance: '$305' },
    { id: 12, status: 'Sent', client: 'Susan Dickerson', email:'don85@johnson.com', total: '$4578', issuedDate: '2024-05-17', balance: 'Paid' },
  ];
  ...
  const ClientCell = (params) => {
    const initials = params.value
      ...
      .join("");
    const email =
      params.value.split(" ").join("").toLowerCase() + "@example.com";
    return (
