...
function ItemManager() {
  ...
  <Box
    ...
    sx={{
      ...
      borderRadius: "4px",
      width: '100%', // Ensure it fits on all screens
    }}
  >
    {/* Labels row visible only on larger screens */}
    <Box sx={{ display: { xs: 'none', sm: 'flex' }, justifyContent: 'space-between', mb: 2 }}>
    ...
    <Grid container spacing={2}>
      ...
      <Grid item xs={6} sm={2}>
        ...
        />
        <Typography variant="body2" sx={{ mt: 2 }}>Discount: 0%</Typography>
      </Grid>
      {/* Hours */}
      <Grid item xs={6} sm={2}>
      ...
      {/* Calculated Price */}
      <Grid item xs={6} sm={1}>
        <Typography sx={{ display: { sm: 'none' }, mt: 1 }}>Price</Typography>
