...
const List = () => {
  ...
  const initialRows = [
    ...
    { id: 9, status: 'Sent', client: 'Carol White', total: '$2770', email:'don85@johnson.com', issuedDate: '2024-05-17', balance: '$400' },
    { id: 10, status: 'Past Due', client: 'David Flores', total: '$4360', issuedDate: '2024-05-17', balance: 'Paid' },
