...
const List = () => {
  ...
  const handleSelectionChange = (newSelectionModel) => {
    console.log("Before update:", selectedRowIds);
    setSelectedRowIds(newSelectionModel);
    console.log("After update should be:", newSelectionModel);
};
useEffect(() => {
  ...
  console.log(selectedRowIds, selectedRowIds.length)
              ...
              <Grid item xs={12}>
                  ...
                  <Box>
                    <FormControl fullWidth>
                      ...
                      <Select
                        ...
                        onChange={(event) => {
                          console.log("Action selected:", event.target.value);
                        }}
                      >
                ...
                <DataGrid
                  ...
                  onSelectionModelChange={(newSelection) => {
                    console.log("Selection model change event fired", newSelection);
