...
const List = () => {
  ...
  const initialRows = [
    { id: 1, status: 'Paid', client: 'John Doe', total: '$1000', issuedDate: '2024-05-13', balance: 'Paid' },
    { id: 2, status: 'Draft', client: 'Jane Smith', total: '$1200', issuedDate: '2024-05-14', balance: '$600' },
    { id: 3, status: 'Sent', client: 'Alice Johnson', total: '$1500', issuedDate: '2024-05-15', balance: '$1500' },
    { id: 4, status: 'Downloaded', client: 'Bob Brown', total: '$700', issuedDate: '2024-05-16', balance: 'Paid' },
    { id: 5, status: 'Partial Payment', client: 'Carol White', total: '$800', issuedDate: '2024-05-17', balance: '$400' },
    { id: 6, status: 'Partial Payment', client: 'Carol White', total: '$800', issuedDate: '2024-05-17', balance: '$400' },
    { id: 7, status: 'Partial Payment', client: 'Carol White', total: '$800', issuedDate: '2024-05-17', balance: '$400' },
    { id: 8, status: 'Partial Payment', client: 'Carol White', total: '$800', issuedDate: '2024-05-17', balance: '$400' },
    { id: 9, status: 'Partial Payment', client: 'Carol White', total: '$800', issuedDate: '2024-05-17', balance: '$400' },
    { id: 10, status: 'Partial Payment', client: 'Carol White', total: '$800', issuedDate: '2024-05-17', balance: '$400' },
    { id: 11, status: 'Partial Payment', client: 'Carol White', total: '$800', issuedDate: '2024-05-17', balance: '$400' },
    { id: 12, status: 'Partial Payment', client: 'Carol White', total: '$800', issuedDate: '2024-05-17', balance: '$400' },
  ];
