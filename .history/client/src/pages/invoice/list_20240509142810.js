...
const List = () => {
  ...
  const statusIcons = {
    Paid: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35 35" fill="green" width="35px" height="35px" style={{borderRadius:'50%', display:"flex", justifyContent:'center', alignContent:}}>
