...
const ChatRoom = () => {
  ...
  return (
    ...
    >
       ...
       <IconButton
      sx={{ position: 'absolute', top: 10, left: 10, zIndex: 1300, display: { md: 'none' } }}
      color="inherit"
      aria-label="open drawer"
      onClick={() => setIsDrawerOpen(!isOpen)}
    >
      <MenuIcon />
    </IconButton>
      <Drawer
        ...
        <Drawer
          ...
          sx={{
            ...
            "& .MuiDrawer-paper": {
              position: "absolute",
              width: '23.5rem',
              left: { xs: "12%", sm: "7%", md: "4%", lg: "44.5%", xl: "45%" },
              top: { xs: "3%", sm: "3%", md: "3%", lg: "0%", xl: "6%" },
              height: "100%",
              boxSizing: "border-box",
              zIndex: 1000,
            },
          ...
          ModalProps={{
            ...
            BackdropProps: {
              sx: {
                // position: "absolute",
                // top: { xs: "3%", sm: "3%", md: "3%", lg: "1.5%", xl: "6%" },
                // left: { xs: "48%", sm: "42%", md: "45%", lg: "45%", xl: "50%" },
                // width: "160%",
                // height: "100%",
                position: "fixed", 
                top: 0, 
