...
const ChatRoom = () => {
          ...
          >
            <Box sx={{ width: 380 }} role="presentation">
              <List>
                ...
                <Box sx={{ p: 2 }}>
                  <Typography variant="body1" sx={{ml:2, color:'rgba(50, 71, 92, 0.6)'}}>Personal Information</Typography>
                  <List dense>
                    {/* Email */}
                    <ListItem>
                      <ListItemIcon>
  ...
  <List dense>
    {/* Existing items... */}
    {/* Additional item example: Add Tag */}
    <ListItem button>
      <ListItemIcon>
    ...
    {/* Additional item example: Important Contact */}
    <ListItem button>
      <ListItemIcon>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    {/* Additional item example: Shared Media */}
    <ListItem button>
      <ListItemIcon>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          <circle cx="7.499" cy="9.5" r="1.5"/>
          <path d="m10.499 14l-1.5-2l-3 4h12l-4.5-6z"/>
    ...
    {/* Additional item example: Delete Contact */}
    <ListItem button>
      <ListItemIcon>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    {/* Additional item example: Block Contact */}
    <ListItem button>
      <ListItemIcon>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
