...
const AppCalendar = () => {
  ...
  const handleChangeDate = (field, value) => {
    const newDateISO = format(new Date(value), { representation: 'complete' });
    if (
      field === "start" &&
              ...
              >
                ...
                <Box>
                  ...
                  <TextField
                    ...
                    type="date"
                    label="Start Date"
                    value={selectedEvent.start ? formatISO(parseISO(selectedEvent.start), { representation: 'complete' }).substring(0, 16) : ''}
                  ...
                  <TextField
                    ...
                    type="date"
                    label="End Date"
                    value={selectedEvent.end ? formatISO(parseISO(selectedEvent.end), { representation: 'complete' }).substring(0, 16) : ''}
        onChange={(e) => handleChangeDateTime('end', e.target.value)}
        min={selectedEvent.start ? formatISO(parseISO(selectedEvent.start), { representation: 'complete' }).substring(0, 16) : ''}
                    margin="normal"
                    InputLabelProps={{ shrink: true }}
                  />
