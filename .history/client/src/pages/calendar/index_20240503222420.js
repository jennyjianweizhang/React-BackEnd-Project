              ...
              >
                ...
                <Box>
                  ...
                  <TextField
                    ...
                    type="date"
                    label="Start Date"
                    value={new Date(selectedEvent.start).toISOString().substring(0, 10)}
                  ...
                  <TextField
                    ...
                    type="date"
                    label="End Date"
                    value={new Date(selectedEvent.end).toISOString().substring(0, 10)}
                    onChange={(e) => handleChange('end', e.target.value)}
                    min={new Date(selectedEvent.start).toISOString().substring(0, 10)}
                    margin="normal"
                    InputLabelProps={{ shrink: true }}
                  />
