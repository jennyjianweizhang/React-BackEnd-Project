        ...
        <Box sx={{ padding: 2, ml: 5 }}>
          ...
          <Box sx={{ display: "flex", flexDirection: "column" }}>
            ...
            <FormControlLabel
              control={
                <Checkbox
                  checked={selectedCategories.includes("Family")}
                  onChange={() => handleCategoryChange("Family")}
                  color="warning"
                />
              }
              label="Family"
            ...
            <FormControlLabel
              control={
                <Checkbox
                  ...
                  onChange={() => handleCategoryChange("Holiday")}
                  color="success"
                />
              }
              label="Holiday"
            ...
            <FormControlLabel
              control={
                <Checkbox
                  checked={selectedCategories.includes("ETC")}
