  ...
  const handleAddEventClick = () => {
    ...
    const handleCheckboxChange = (event) => {
        ...
        if (name === "viewAll") {
          ...
          // Check if all filters except 'viewAll' are true
          const allChecked = Object.entries(updatedFilters)
            .filter(([key]) => key !== "viewAll")  // Exclude 'viewAll' from the check
            .every(([, value]) => value);  // Check if every filter is true
      
          // Update filters with the new values and adjust 'viewAll' accordingly
          setFilters({
            ...updatedFilters,
            viewAll: allChecked,
          });
