...
const AppCalendar = () => {
  ...
  const handleReset = () => {
    setSelectedEvent({
        ...initialEvent,guests: initialGuests,start: initialEvent.start ? ensureDateTimeFormat(initialEvent.start) : null,
    end: initialEvent.end ? ensureDateTimeFormat(initialEvent.end) : null,})
  }
  const closeDrawer = () => {
    setDrawerOpen(false);
  };
