...
const AppCalendar = () => {
  ...
  useEffect(() => {
    if (selectedEvent) {
      ...
      setGuests(selectedEvent.extendedProps.guests.split(',').map(guest => guest.trim()));
              ...
              >
                ...
                <Box>
                  ...
                  <FormControl fullWidth margin="normal">
                    ...
                    <Select
                      value={selectedEvent.extendedProps.guests}
                      label="Guests"
                      onChange={(e) => setGuests(e.target.value)}
    renderValue={(selected) => selected.join(', ')}
  >
    {["John", "Jane", "Smith", "Alice", "Bob", "Carol", "Frank", "Gary", "Ivy", "Joe", "Leo", "Nick", "Patty", "Rachel", "Steve", "Uma"].map((name) => (
      <MenuItem key={name} value={name}>
        <Checkbox checked={guests.indexOf(name) > -1} />
