...
const AppCalendar = () => {
  ...
  const handleChangeDateTime = (field, value) => {
    const newDateISO = formatISO(new Date(value), { representation: 'complete' }); // Format to full ISO string

    // Adjust the end time automatically if it becomes less than the start time
