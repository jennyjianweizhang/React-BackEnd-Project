...
const AppCalendar = () => {
  ...
  const formatDateForInput = (date) => {
    ...
    // Check if date is a string and try to parse it, or use the date as is if it's a Date object
    const dateObj = typeof date === 'string' ? parseISO(date) : date;
    return format(dateObj, 'yyyy-MM-dd\'T\'HH:mm'); // Format as datetime-local string
};
