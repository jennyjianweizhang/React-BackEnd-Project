...
// };
  ...
  console.log("Processed Start Date:", formatDateForInput(selectedEvent.start));
  console.log("Processed End Date:", selectedEvent.end ? formatDateForInput(selectedEvent.end) : "No end date provided, using start date.");
