...
const AppCalendar = () => {
  ...
  const handleChangeDateTime = (field, value) => {
    const newDateISO = formatISO(new Date(value), { representation: 'complete' }); 
  ...
  return (
    <Box className="app-calendar" sx={{ display: "flex" }}>
      ...
      >
        ...
        onChange={(e) => handleChangeDateTime('start', e.target.value)}
                    margin="normal"
                  ...
                  <TextField
                    ...
                    value={
                      selectedEvent.end
                        ? format(parseISO(selectedEvent.end), "yyyy-MM-dd")
                        : ""
                    }
