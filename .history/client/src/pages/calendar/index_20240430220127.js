...
const AppCalendar = () => {
  ...
  const handleEventClick = (clickInfo) => {
    setSelectedEvent({
        ...
        start: clickInfo.event.start.toISOString(),  // Ensures the date is in ISO string format
        end: clickInfo.event.end.toISOString(),      // Ensures the date is in ISO string format
        classNames: clickInfo.event.classNames.join(' '),
