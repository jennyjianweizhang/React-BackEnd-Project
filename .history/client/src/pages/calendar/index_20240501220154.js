...
useEffect(() => {
  ...
  const handleEventClick = (clickInfo) => {
    const { guests, category } = clickInfo.event.extendedProps;  // Assuming these are stored under extendedProps
    ...
    setSelectedEvent({
      ...
      guests,   // Assigning guests from extendedProps
      category  // Assigning category from extendedProps
    });
              ...
              >
                ...
                <Box>
                  ...
                  <FormControl fullWidth margin="normal">
                    ...
                    <Select
                      ...
                      onChange={(e) => {
                        ...
                        setSelectedEvent(prev => ({ ...prev, category: e.target.value }));
                      }}
                    >
                  ...
                  <TextField
                    ...
                    type="date"
                    label="Start Date"
                    value={selectedEvent.start ? selectedEvent.start.split("T")[0] : ''} 
                    onChange={(e) =>
                        setSelectedEvent(prev => ({ ...prev, start: e.target.value + 'T00:00:00' })) 
                      }
                    margin="normal"
                  ...
                  <TextField
                    ...
                    type="date"
                    label="End Date"
                    value={selectedEvent.end ? selectedEvent.end.split("T")[0] : ''}
                    onChange={(e) =>
                        setSelectedEvent(prev => ({ ...prev, end: e.target.value + 'T00:00:00' }))
                      }
                    margin="normal"
                    InputLabelProps={{ shrink: true }}
                  />
