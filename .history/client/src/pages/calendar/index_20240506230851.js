  ...
  const handleAddEventClick = () => {
    ...
    const filteredEvents = useMemo(() => {
        ...
        return events.filter(event =>
            ...
            (filters.etc && event.category?.toLowerCase() === 'personal')
        );
    }, [events, filters]);
    ...
    const handleCheckboxChange = (event) => {
        ...
        // If the user toggles 'View All'
        if (name === "viewAll") {
          const allOrNone = checked ? true : false; // Set all to true or false based on 'View All' checkbox
          setFilters({
            viewAll: allOrNone,
            personal: allOrNone,
            business: allOrNone,
          ...
          // Manually calculate if all other checkboxes are checked
          const allOthersChecked = Object.keys(updatedFilters)
            .filter(key => key !== 'viewAll') // Ignore the 'viewAll' key
            .every(key => updatedFilters[key]); // Check if all are true
      
          // Set 'View All' based on whether all checkboxes are checked
          updatedFilters.viewAll = allOthersChecked;
      
          setFilters(updatedFilters);
        }
      };
      
      console.log(events.map(event => event.category)); // This will show you all categories currently used in your events
