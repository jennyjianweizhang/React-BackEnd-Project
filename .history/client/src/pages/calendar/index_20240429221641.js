      ...
      >
        ...
        <Grid item xs={12} md={12} sx={{ display: 'flex', justifyContent: 'flex-end' }}>
                        <ButtonGroup variant="contained" aria-label="view control buttons">
                            <Button onClick={() => handleViewChange('dayGridMonth')} color="primary">Month</Button>
                            <Button onClick={() => handleViewChange('timeGridWeek')} color="primary">Week</Button>
                            <Button onClick={() => handleViewChange('timeGridDay')} color="primary">Day</Button>
                            <Button onClick={() => handleViewChange('listMonth')} color="primary">List</Button>
                        </ButtonGroup>
                    </Grid>
          <FullCalendar
