...
const AppCalendar = () => {
  ...
  const [title, setTitle] = useState(currentEventData.title);
  const [calendarType, setCalendarType] = useState(currentEventData.category);
  const [allDay, setAllDay] = useState(true);
  const [start, setStart] = useState(currentEventData.start);
  const [endDate, setEndDate] = useState(currentEventData.end);
  const [guests, setGuests] = useState(currentEventData.guests);
