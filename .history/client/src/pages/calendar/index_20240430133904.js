    ...
    <Box className="app-calendar" sx={{ display: "flex" }}>
      ...
      >
        <Grid item xs={12} md={6}>
          ...
          <Box sx={{ '.fc-toolbar': { backgroundColor: '#f4f4f4', padding: 2, borderBottom: '1px solid #ccc' },
           '.fc-toolbar-title': { color: '#333', fontSize: '20px' },
           '.fc-button': { backgroundColor: '#0066cc', color: 'white', border: 'none',
                           '&:hover': { backgroundColor: '#005cbf' } }
         }}><FullCalendar
