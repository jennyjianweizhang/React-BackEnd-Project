    ...
    >
      <Toolbar className="navbar-content-container">
        <Box
          ...
          sx={{ display: "flex", alignItems: "center", ml: isMobile ? 0 : -8 }}
        >
        ...
        <Box className="actions-right">
          ...
          >
            <MenuItem onClick={handleMenuClose}>
              {/* {console.log("Link rendering with path: ", "/email")} */}
              <Link href="/email">
                <a style={{ textDecoration: 'none', color: 'inherit' }}>Inbox</a>
              </Link>
            </MenuItem>
            <MenuItem onClick={handleMenuClose}>
              <Link href="/chat">
                <a style={{ textDecoration: 'none', color: 'inherit' }}>Chat</a>
              </Link>
            </MenuItem>
            <MenuItem onClick={handleMenuClose}>
              <Link href="/account-settings" >
                <a style={{ textDecoration: 'none', color: 'inherit' }}>Setting</a>
              </Link>
            </MenuItem>
            <MenuItem onClick={handleMenuClose}>
              <Link href="/">
                <a style={{ textDecoration: 'none', color: 'inherit' }}>Sign Out</a>
              </Link>
            </MenuItem>
          </Menu>
        </Box>
