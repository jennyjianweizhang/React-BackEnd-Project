    ...
    <AppBar position="sticky" color="default" elevation={0} className="layout-navbar">
      <Toolbar className="navbar-content-container">
        ...
        <Box className="actions-right">
          ...
          <Badge overlap="circular" anchorOrigin={{ vertical: 'bottom', horizontal: 'right' }} badgeContent={<span></span>} onClick={handleMenuOpen}>
        ...
        >
          <MenuItem component={RouterLink} to="/profile">Inbox</MenuItem>
