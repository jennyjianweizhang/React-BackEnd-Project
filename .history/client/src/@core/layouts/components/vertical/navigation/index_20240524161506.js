  ...
  return (
    <Drawer {...props}>
      ...
      <StyledBoxForShadow ref={shadowRef} sx={{
        background: `linear-gradient(${theme.palette.background.default} 40%, rgba(${theme.palette.background.default}, 0.1) 95%, rgba(${theme.palette.background.default}, 0.05))`
      }} />
      <Box sx={{ height: '100%', position: 'relative', overflow: 'hidden' }}>
        <PerfectScrollbar
          onScrollY={container => scrollMenu(container)}
